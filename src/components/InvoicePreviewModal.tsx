    ...
    >
      <div className="w-full max-w-4xl h-[95vh] sm:h-[92vh] bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 flex flex-col md:flex-row min-h-0 overflow-hidden">
            ...
            <div className="space-y-2 pt-2 border-t border-slate-100 dark:border-slate-800/60">
              ...
              {onEdit && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 py-2.5 px-3 border border-indigo-200 dark:border-indigo-800 bg-indigo-50 dark:bg-indigo-955/20 hover:bg-indigo-100 dark:hover:bg-indigo-950/40 text-indigo-700 dark:text-indigo-300 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer shadow-2xs"
          ...
          <div className={`${mobileTab === 'details' ? 'hidden md:flex' : 'flex'} flex-1 bg-slate-100 dark:bg-slate-950/40 p-2 sm:p-4 flex-col items-center min-h-0 relative overflow-hidden`}>
            ...
            <div className="w-full max-w-[680px] mb-2 flex items-center justify-between gap-2 px-1 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[11px] sm:text-xs font-mono font-bold text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-900 px-2.5 py-1 rounded-lg border border-slate-200 dark:border-slate-800 shadow-xs">
                  ₹{resolvedInvoice.total.toLocaleString()}
                </span>
              </div>
            </div>
